...
def parse_args():
    ...
    parser.add_argument('--n-objects', type=int, choices=[6, 8], default=8)
...
def main():
    ...
    from .reporting import (
        build_dynamic_out_dir, build_grouped_summary, save_grouped_plots,
        summarize_subset, write_grouped_summary_csv, write_trial_csv,
    )
    from .runtime import EARLY_SUCCESS_FIXATIONS, ensure_dir, set_runtime_geometry, set_seed
    ...
    set_seed(args.seed)
    set_runtime_geometry(args.n_objects)
    ...
    grouped = build_grouped_summary(all_results, args.n_objects)
